<script lang="ts">
	...
	import { ModalController, modalStore } from '$lib/components/organisms/modal';
	...
	import CountdownTimer from '../pricing/CountdownTimer.svelte';
	import PaymentTypeSelector from '../pricing/PaymentTypeSelector.svelte';
	import BonusBox from '../pricing/BonusBox.svelte';
	import DiscountBanner from '../pricing/DiscountBanner.svelte';
	import TermsConditions from '../pricing/TermsConditions.svelte';
	import PaymentMethods from '../pricing/PaymentMethods.svelte';
	import TrustBadges from '../pricing/TrustBadges.svelte';
	import PricingHeader from '../pricing/PricingHeader.svelte';
...
{#key $currentLocale}
	<div class="pricing-options mt-8">
		<!-- Header -->
		<PricingHeader {score} {translationLabels} />

		<!-- Countdown Timer -->
		<CountdownTimer {hours} {minutes} {seconds} {discountDuration} />

		<!-- Bonus-Box für Aktionsangebot -->
		<BonusBox isVisible={sectionsInView.bonusBox} {benefits} />

		<!-- Payment Type Toggle -->
		<PaymentTypeSelector {paymentType} onPaymentTypeChange={handlePaymentTypeChange} />
		...
		<DiscountBanner
			isVisible={sectionsInView.discountBanner}
			onPaymentTypeChange={handlePaymentTypeChange}
		/>

		<!-- Terms -->
		<TermsConditions {paymentType} {selectedPlan} {totalPrice} />
	</div>
{/key}

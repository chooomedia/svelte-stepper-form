...
const ru: Translation = {
	...
	modal: {
		...
		buttons: {
			...
			getReport: 'Получить отчет по электронной почте',
			emailError: 'Пожалуйста, укажите адрес электронной почты в форме для получения результатов.',
			bookNow: 'Забронировать встречу сейчас'
		},
		cta: {
			readyTitle: 'Готовы к следующему шагу?',
			bookingText: 'Забронируйте бесплатную консультацию сейчас, и давайте вместе улучшим вашу онлайн-видимость.'
		},
		restartModal: {
			title: 'Вы действительно хотите начать заново?',
			message: 'Вы уже вложили время и получили ценную информацию о своей онлайн-видимости.',
			suggestion: '💡 Лучше воспользуйтесь нашей бесплатной консультацией и сэкономьте время на оптимизации!',
			bookInstead: '✨ Забронировать встречу вместо этого',
			cancel: 'Отмена',
			confirmRestart: 'Всё равно начать заново'
		},
		screenshot: {
			alt: 'Скриншот сайта',
			unsupported: 'Данные скриншота доступны, но формат не поддерживается'
		}
	},
	waitingScreen: {

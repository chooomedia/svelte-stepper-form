...
const ar: Translation = {
	...
	modal: {
		...
		buttons: {
			restart: 'إعادة بدء التحليل',
			getReport: 'احصل على تقرير التحليل عبر البريد الإلكتروني',
			emailError: 'يرجى تقديم عنوان بريد إلكتروني في النموذج للحصول على النتائج.',
			bookNow: 'احجز موعدًا الآن'
		},
		cta: {
			readyTitle: 'هل أنت مستعد للخطوة التالية؟',
			bookingText: 'احجز استشارتك المجانية الآن ودعنا نحسن ظهورك على الإنترنت معًا.'
		},
		restartModal: {
			title: 'هل تريد حقًا البدء من جديد؟',
			message: 'لقد استثمرت بالفعل وقتًا وحصلت على رؤى قيمة حول ظهورك على الإنترنت.',
			suggestion: '💡 من الأفضل استخدام استشارتنا المجانية وتوفير الوقت في التحسين!',
			bookInstead: '✨ احجز موعدًا بدلاً من ذلك',
			cancel: 'إلغاء',
			confirmRestart: 'ابدأ من جديد على أي حال'
		},
		screenshot: {
			alt: 'لقطة شاشة الموقع',
			unsupported: 'بيانات لقطة الشاشة متاحة ولكن التنسيق غير مدعوم'
		}
	},
	waitingScreen: {

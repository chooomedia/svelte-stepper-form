			...
			'@graph': [
				{
					...
					logo: 'https://digitalpusher.de/logo.svg',
					sameAs: [
				...
				},
				{
					...
					primaryImageOfPage: {
						'@type': 'ImageObject',
						url: 'https://digitalpusher.de/logo.svg'
					}
				}
			]
		};
...
<main class="flex min-h-screen flex-col bg-gray-100 {isEmbedded ? 'embedded' : ''}">
	{#if !isIframe}
	...
	<section
		class="flex flex-1 flex-col {isIframe ? 'py-0' : 'py-7'}"
		itemscope
